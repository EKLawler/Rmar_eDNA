...
#===============================================================================
#===============================================================================
#========== Code to run occupancy model and generate Figures 3., 4., A1., & B1. 
#===============================================================================
#===============================================================================
...
#-------------------------------------------------------------------------------
#------------------- Data preparation for occupancy model
...
# label qPCR replicates and get unique sample values
pcr <- pcr |>
...
# latent parameter for whether DNA is present at a site = z
...
## Load in covariates (influencing factors) 
...
#-------------------------------------------------------------------------------
#----------------- Get parameter estimate outputs
...
# All factors excluding tadpoles
post1 <- ggplot() + 
...
# combine all posterior distribution plots
...
#-------------------------------------------------------------------------------
# Calculate survey sensitivity for each site 
...
sens.hist
#-------------------------------------------------------------------------------
# Arrange posterior distributions and survey sensitivity histograms to generate Fig 3.
...
#-------------------------------------------------------------------------------
# # calculate the number of samples the required for 0.95 sensitivity at each site
...
#-------------------------------------------------------------------------------
#---------Number of samples vs PCR reps for increasing sensitivity (Figure A1.)
#-------------------------------------------------------------------------------
...
# plot for no tadpole situations (Fig 4.)
...
# save Fig 4.
ggsave("Fig4.jpeg", width = 16, height = 18, units = "cm")

#-------------------------------------------------------------------------------
# Add credible intervals to generate Fig B1.
...
# save
ggsave("FigB1.jpeg", width = 16, height = 18, units = "cm")
